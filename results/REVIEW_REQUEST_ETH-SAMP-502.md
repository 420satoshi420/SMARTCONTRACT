...
Suite result: ok. 2 passed; 0 failed; 0 skipped; finished in 776.53µs (260.67µs CPU time)

Ran 1 test for contracts/test/invariants/POC_RED-001.t.sol:POC_RED001
[PASS] test_Exploit_VaultReentrancyDrain() (gas: 162416)
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 1.08ms (415.77µs CPU time)
...
Suite result: ok. 3 passed; 0 failed; 0 skipped; finished in 329.47ms (595.62µs CPU time)

Ran 3 test suites in 332.23ms (331.32ms CPU time): 6 tests passed, 0 failed, 0 skipped (6 total tests)
```
...
git checkout -b fix/ETH-SAMP-502
