...
Suite result: ok. 2 passed; 0 failed; 0 skipped; finished in 703.42µs (260.20µs CPU time)

Ran 1 test for contracts/test/invariants/POC_RED-001.t.sol:POC_RED001
[PASS] test_Exploit_VaultReentrancyDrain() (gas: 162416)
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 1.53ms (954.31µs CPU time)
...
Suite result: ok. 3 passed; 0 failed; 0 skipped; finished in 260.30ms (633.66µs CPU time)

Ran 3 test suites in 262.66ms (262.53ms CPU time): 6 tests passed, 0 failed, 0 skipped (6 total tests)
```
...
git checkout -b fix/ETH-SAMP-832
