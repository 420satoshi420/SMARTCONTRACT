# 🌿 PearlAI Token ($PEARL) & MassageMap Thailand Technical Whitepaper
...
**PearlAI Token ($PEARL)** is the decentralized utility and governance token powering **MassageMap Thailand** ([massagemapthailand.com](https://massagemapthailand.com)). It bridges decentralized finance (DeFi) with real-world wellness services, enabling:
* **Zero-Fee Direct Bookings:** Direct customer-to-merchant crypto payments.
* **Review-to-Earn (R2E):** Cryptographically verified reviews rewarded in $PEARL.
* **Merchant Quality Staking:** Spas stake $PEARL to secure premium directory placement and verified provenance badges.
...
graph TD
    ...
    Merchant -->|Stake $PEARL for Priority & Tier| Pool
...
Tourists visiting Thailand can pay for massages, wellness retreats, and spa packages directly using $PEARL, ETH, or stablecoins through the MassageMap Thailand Web3 booking engine. 
...
* After the massage session, submitting a verified review mints an on-chain verification hash and awards the customer bonus $PEARL tokens.

### 2.3. Merchant Staking & Tiered Visibility
Massage shops and independent therapists across Bangkok, Chiang Mai, Phuket, and Pattaya stake $PEARL tokens to unlock platform tiers:
* **Tier 1 (Explorer):** Basic listing on MassageMap Thailand.
* **Tier 2 (Verified Partner):** 5,000 $PEARL staked → Verified blue badge, top 10 search priority in district.
* **Tier 3 (Master Spa & Wellness Center):** 25,000 $PEARL staked → Featured hero placement, automated multi-language AI translation, and zero booking commission.
...
* **Total Supply:** `1,000,000 PEARL` (Fixed Cap)

```mermaid
pie title $PEARL Token Allocation
    "Community Staking & Wellness Rewards" : 45
    "DEX Liquidity Pool (ETH/PEARL)" : 25
...
| :--- | :--- | :--- | :--- |
| **Community Staking & Rewards** | 45% | 450,000 PEARL | Distributed linearly via AMM Yield Pool |
| **DEX Liquidity Pool** | 25% | 250,000 PEARL | 100% unlocked for Uniswap/PearlAIPool seeding |
| **Merchant Onboarding Grants** | 15% | 150,000 PEARL | 6-month milestone releases for verified spas |
| **Ecosystem & Platform Dev** | 10% | 100,000 PEARL | 12-month linear vesting for massagemapthailand.com |
| **Core Team & Contributors** | 5% | 50,000 PEARL | 12-month lockup, 6-month linear vesting |

---

## 4. Smart Contract Architecture

The PearlAI Protocol smart contract suite consists of two core audited components:

### 4.1. `PearlAIToken.sol` (ERC-20 + EIP-2612)
...
### 4.2. `PearlAIPool.sol` (AMM + Staking Engine)
